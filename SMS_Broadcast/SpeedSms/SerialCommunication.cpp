...
int SerialCommunication::Open(CString name)
{
	...
	//m_serialParam.m_CommTimeouts.ReadIntervalTimeout = MAXDWORD;
	//m_serialParam.m_CommTimeouts.ReadTotalTimeoutConstant = 0;
	//m_serialParam.m_CommTimeouts.ReadTotalTimeoutMultiplier = 0;
	//m_serialParam.m_CommTimeouts.WriteTotalTimeoutConstant = 1000;
	//m_serialParam.m_CommTimeouts.WriteTotalTimeoutMultiplier = 10;
